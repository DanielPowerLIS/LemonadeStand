...
public class UserInterface {
    ...
    public void runSupplierMenu(Scanner scanner){
        int option = -1;
        while(option != 5){
            showSuppliersMenu();
            option = scanner.nextInt();
    ...
    private void handleUpdateSupplier(Scanner scanner){
        ...
        String newContactEmail = scanner.next();

        Supplier updatedSupplier = supplierService.updateSupplier(id, newName, newContactEmail);
    ...
    private void handleRemoveSuppliers(Scanner scanner){
        System.out.print("Write the ID of the supplier to be removed: ");
